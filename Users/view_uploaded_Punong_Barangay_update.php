  ...
  <div class="modal-dialog">
    <div class="modal-content">
       <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Punong Barangay Certification na ikaw ay Solo Parent</h5>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-success" name="update_solo_parent">Update</button>
      </div>
        </form>
    </div>
  </div>
