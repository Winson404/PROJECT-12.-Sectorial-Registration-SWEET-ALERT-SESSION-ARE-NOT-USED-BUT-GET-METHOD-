  ...
  <div class="content-wrapper ">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Salaysay Na Ikaw Ay Walang Kinakasama Sa Kasalukuyan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Salaysay Na Ikaw Ay Walang Kinakasama Sa Kasalukuyan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Salaysay Na Ikaw Ay Walang Kinakasama Sa Kasalukuyan</h3>
              </div>
             
              <?php if($row_fetch['Walang_Kinakasama'] == ""): ?>
              ...
              <?php else: ?>
              <img src="../images-documents/<?php echo $row_fetch['Walang_Kinakasama']; ?>" alt="" style="width: 1000px;padding: 20px 20px; display: block;margin-left: auto;margin-right: auto;">
            <?php endif; ?>
             ...
             <br>
            <?php include 'view_uploaded_Walang_Kinakasama_update.php'; ?>
            </div>
            <!-- /.card -->
         </div>
          <!--/.col (left) -->
