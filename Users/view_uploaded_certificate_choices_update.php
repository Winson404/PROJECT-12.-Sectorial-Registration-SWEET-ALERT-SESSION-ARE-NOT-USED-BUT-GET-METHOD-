  ...
  <div class="modal-dialog">
    <div class="modal-content">
       <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Mamili Lang Po Ng Isa (1) Lamang Sa Mga Sumusunod Kung Ano Ang Applicable Sa Inyo</h5>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-success" name="certificate_choices">Update</button>
      </div>
        </form>
    </div>
  </div>
