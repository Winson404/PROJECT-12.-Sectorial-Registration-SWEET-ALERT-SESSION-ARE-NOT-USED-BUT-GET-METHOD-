  ...
  <div class="modal-dialog">
    <div class="modal-content">
       <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Kopya Ng Birth Certificate Ng Anak Ng Below 18 Years Old At Anak Na Kahit Lampas Na 18 Years Old Basta May Malubhang Kapansanan</h5>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-success" name="Kopyanganak">Update</button>
      </div>
        </form>
    </div>
  </div>
