          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Barangay Certification</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Barangay Certification</h3>
              </div>
             
              <?php if($row_fetch['Barangay_Certification'] == ""): ?>
                <h3 class="p-3">You haven't uploaded a Barangay Certification yet.</h3>
                <p style="margin-left: 20px;"><a href="upload_ID.php?household_Id=<?php echo $household_Id; ?>">Click here</a> to upload.</p>
              <?php else: ?>
              <img src="../images-documents/<?php echo $row_fetch['Barangay_Certification']; ?>" alt="" style="width: 1000px;padding: 20px 20px; display: block;margin-left: auto;margin-right: auto;">
            <?php endif; ?>
             ...
             <br>
            <?php include 'view_uploaded_Barangay_Certification_update.php'; ?>
            </div>
            <!-- /.card -->
         </div>
          <!--/.col (left) -->
