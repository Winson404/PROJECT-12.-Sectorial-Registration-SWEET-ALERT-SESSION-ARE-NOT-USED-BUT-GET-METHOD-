  ...
  <div class="modal-dialog">
    <div class="modal-content">
       <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Barangay Certification of Residency</h5>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-success" name="Birth_certificate">Update</button>
      </div>
        </form>
    </div>
  </div>
