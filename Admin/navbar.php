  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <!--  <li class="nav-item dropdown">
      ...
      <?php 
        $fetch = mysqli_query($conn, "SELECT message_Id FROM message");
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <?php 
          $fetch_all = mysqli_query($conn, "SELECT * FROM message JOIN household_head ON message.message_household_Id=household_head.household_Id ORDER BY message_Id DESC LIMIT 6");
