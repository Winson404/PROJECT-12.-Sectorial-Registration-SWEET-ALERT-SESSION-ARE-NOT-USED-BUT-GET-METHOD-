        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Solo Parent</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM household_head WHERE sectorial_registration LIKE 'Solo Parent,' AND action='Restore' AND account_status='Approved'");
                      ...
                      ?>
                        ...
                        <td>
                            ...
                            <a href="solo_parent_print.php?household_Id=<?php echo $row['household_Id']; ?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                            <a href="solo_parent_update.php?household_Id=<?php echo $row['household_Id']; ?>" class="btn btn-success"><i class="fa-solid fa-pen-to-square"></i></a>
                            ...
                            <a href="solo_parent_documents.php?household_Id=<?php echo $row['household_Id']; ?>" class="btn btn-info"><i class="fa-solid fa-file"></i></a> 
                  ...
                  <?php include 'solo_parent_delete.php'; include 'view_record.php';  } ?>
