              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM household_head WHERE sectorial_registration LIKE 'Solo Parent,'");
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      ...
                                      <a href="solo_parent_update.php?household_Id=<?php echo $row['household_Id']; ?>" class="btn btn-primary dropdown-item">Update</a>
