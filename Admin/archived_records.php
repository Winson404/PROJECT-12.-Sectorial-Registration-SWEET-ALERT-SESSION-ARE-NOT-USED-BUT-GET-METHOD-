              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM household_head WHERE action='Archive'");
                      ...
                      ?>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#restore<?php echo $row['household_Id']; ?>"><i class="fa-solid fa-window-restore"></i></button> 
                        </td>  
                    </tr>

                    <?php include 'archived_records_restore.php'; } ?>
                  </tbody>
                  <tfoot>
                      <tr>
                        <th>Full name</th>
