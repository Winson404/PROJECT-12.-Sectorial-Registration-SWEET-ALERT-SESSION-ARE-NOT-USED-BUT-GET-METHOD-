              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM message JOIN household_head ON message.message_household_Id=household_head.household_Id");
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#reply<?php echo $row['message_Id']; ?>">Add message</button>
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#view<?php echo $row['message_Id']; ?>">View</button>
                                      ...
                                      <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#delete<?php echo $row['message_Id']; ?>">Delete</button>
                                </div>
                            </div>
                        </td> 
                    </tr>
